...
conversation_tree = {
	#"Hey, we noticed that you Tweeted about police misconduct. I'm a bot working on behalf of Blue Witness to gain supplementary information about these reports in order to track these incidents for the sake of social accountability. We noticed that the location and time of this incident are missing from your Tweet, are you willing to help us gain the information we need?"
	1:"Hey, we noticed that you Tweeted about an indicent involving police. I'm a bot working on behalf of Blue Witness to gain supplementary information about these reports. If you are willing to assist, please press the link below.",
...
class TwitterBot():
	...
	def step_3(self):
		processed_dms = twitter.process_dms(
			user_id=max_step.in_reply_to_id,
			tweet_id=max_step.tweet_id,
			convo_tree_txt=conversation_tree[11])
...
def advance_conversation(root_id: int, form_link: str = None) -> str:
	...
	twitter_dispatch = {
		1:twitter_bot.step_1,
		2:twitter_bot.step_2,
		10:twitter_bot.step_3,
		12:twitter_bot.step_4,
		# 5:twitter_bot.step_5,
	}
	if max_step.conversation_status == 10:
	...
	# print(type(max_step))
	# print(twitter_dispatch[max_step.conversation_status])
	# twitter_dispatch[max_step.conversation_status]()
	...
	# elif max_step.conversation_status == 11:
